...
export default function Nav({ location }: Props) {
  ...
  `);
  return (
    <nav className="w-full h-[60px] flex justify-between mx-auto max-w-5xl mt-4">
      ...
      <div className="flex justify-between items-center w-2/6">
        <ul className="flex space-x-10 text-xl">
          <li className={cls(location?.substring(0, 6) === "/blog/" ? "border-b-4 border-b-black font-bold" : "")}>
            <Link to="/blog">BlOG</Link>
          </li>
          <li className={cls(location === "/about/" ? "border-b-4 border-b-black font-bold" : "")}>
